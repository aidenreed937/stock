...
from stock_data.governance.validator import OfflineDataValidator
...
def test_validator_main(monkeypatch):
    ...
    from stock_data.governance.validator import main
    ...
    monkeypatch.setattr("stock_data.governance.validator.DuckDBMarketStore", lambda: mock_store)
    main()
...
def test_validator_entrypoint(monkeypatch):
    ...
    with patch("stock_data.governance.validator.main") as mock_main:
        runpy.run_module("stock_data.governance.validator", run_name="__main__")
