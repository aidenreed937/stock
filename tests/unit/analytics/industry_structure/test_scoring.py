...
def test_score_industry_panel_adds_ranks_and_tags() -> None:
    panel = pl.DataFrame(
        {
            "industry_code": ["801001.SI", "801002.SI", "801003.SI"],
            "industry_name": ["强行业", "便宜行业", "弱行业"],
            "as_of_date": [date(2026, 8, 14)] * 3,
            "fundamental_date": [date(2026, 3, 31)] * 3,
            "return_5d": [5.0, 1.0, -2.0],
            "return_20d": [20.0, 2.0, -10.0],
            "return_60d": [35.0, 8.0, -20.0],
            "relative_return_20d": [15.0, 1.0, -12.0],
            "ma_bias_20d": [8.0, 0.5, -6.0],
            "tcr": [18.0, 6.0, 3.0],
            "tcr_percentile": [90.0, 30.0, 10.0],
            "pe_percentile_5y": [80.0, 10.0, 40.0],
            "pb_percentile_5y": [70.0, 15.0, 35.0],
            "pbroe_residual": [0.5, -0.5, 0.0],
            "revenue_growth_percentile": [70.0, 65.0, 20.0],
            "profit_growth_percentile": [75.0, 70.0, 15.0],
            "roe_percentile": [80.0, 60.0, 25.0],
            "forecast_positive_share": [90.0, 50.0, 10.0],
            "forecast_p_change_mid_median": [120.0, 20.0, -30.0],
            "express_profit_growth_median": [80.0, 30.0, -20.0],
            "express_roe_median": [10.0, 8.0, 3.0],
            "report_rc_revision_ratio": [70.0, 55.0, 20.0],
        }
    )
    ...
    assert scores["industry_count"] == 3
    ...
    assert scores["fundamental_status_counts"]["stale_blended"] == 3
