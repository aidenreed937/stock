...
RAW_SYMBOL_COLUMNS = ("symbol", "ts_code", "stockCode", "code", "index_id", "industry_id", "index_code")
RAW_ENTITY_COLUMNS = ("ts_code", "symbol", "stockCode", "code", "index_id", "industry_id", "index_code")
RAW_DATE_CANDIDATE_COLUMNS = ("trade_date", "date", "end_date", "ann_date", "month", "quarter", "suspend_date")
RAW_PRIMARY_KEY_FALLBACK_COLUMNS = (
    "symbol", "stockCode", "ts_code", "code", "index_id", "industry_id", "index_code",
    "con_code", "exchange_id", "market_type", "report_type", "trade_date", "date",
    "end_date", "ann_date", "month", "quarter",
)
