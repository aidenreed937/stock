...
_CUSTOM_TASKS: dict[tuple[str, str], TaskSpec] = {
    ...
    ("tushare", "moneyflow_ind_dc"): _make_spec("moneyflow_ind_dc", "tushare", "moneyflow_ind_dc", "moneyflow_ind_dc", fetch_mode="per_day", partitioned=True),
...
_ALIASES: dict[tuple[str, str], str] = {
    ...
    ("tushare", "moneyflow_ind"): "moneyflow_ind_dc",
