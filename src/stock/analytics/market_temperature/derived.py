...
def _money_credit_rows(
    ...
    cn_m = _with_month_date(_load_dataset(cat_ts, "cn_m"))
    sf_month = _with_month_date(_load_dataset(cat_ts, "sf_month"))
...
def _external_macro_rows(cat: DataCatalog, as_of_date: date) -> list[dict[str, Any]]:
...
def _percentile_metric_row(  # noqa: PLR0913
    frame: pl.DataFrame,
    metric_id: str,
    value_col: str,
    as_of_date: date,
