...
from stock_reporting.interpretation.market_temperature.config import BandsConfig
...
_METRIC_LABELS: dict[str, str] = {
    ...
    "macro_sp500_1d_return": "标普500 1日收益",
    "macro_nasdaq_1d_return": "纳斯达克 1日收益",
    "macro_sox_1d_return": "费城半导体 1日收益",
    "macro_vix_1d_change": "VIX 1日变化",
    "macro_us_10y_1d_change": "美债10年期收益率 1日变化",
