...
from stock_data.planner import _filter_supported_symbols, _should_expand_single_sync
from stock_data.task_registry import expand_task_targets, resolve_task
...
class DailySyncEngine:
    ...
    def sync_daily(
        ...
        if run_audit_gate and any(r.status == "SUCCESS" for r in exec_results):
            try:
                from stock_data.audit.reconciliation import run_audit
