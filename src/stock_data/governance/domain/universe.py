...
from stock_data.fetcher.tushare import TuShareDataFetcher
from stock_data.governance.domain.rules import (
    BasicExclusionRule,
    CompositeRuleChain,
    LiquidityRule,
    ValuationRule,
                ...
                if (
                    ...
                    try:
                        ...
                        if not df_db_pl.is_empty() and "trade_date" in df_db_pl.columns:
                            ...
                            if len(cols) > 1:
                                df_pd = df_pd.merge(df_db_latest[cols], on="ts_code", how="left")
                    except Exception as e:
